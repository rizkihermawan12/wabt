const  XBOT = 'RIZKIBOT'; // Nama Bot Whatsapp
...
const youtube = 'https://youtube.com/channel/UCFP1cgQfnbLpkB3DEshAAsw'; 
...
conn.sendMessage(id, ' Thanks Telah Menggunakan BOT *RIZKIBOT* , Follow Instagram Mimin Yah� : https://instagram.com/hermawanrisky02' ,MessageType.text);
}
else if (text == '#info'){
conn.sendMessage(id, ' Thanks Telah Menggunakan BOT *RIZKIBOT* , Follow Instagram Mimin Yah� : https://instagram.com/hermawanrisky02' ,MessageType.text);
}
